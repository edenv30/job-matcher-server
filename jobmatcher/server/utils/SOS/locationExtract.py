...
def extract_location():
    st = StanfordNERTagger('C:/Users/cheny/Desktop/stanford-ner-2018-10-16/classifiers/english.all.3class.distsim.crf.ser.gz',
                           'C:/Users/cheny/Desktop/stanford-ner-2018-10-16/stanford-ner.jar')
    ...
    data = pd.read_csv(
        'C:\\Users\\cheny\\PycharmProjects\\server\\job-matcher-server\\jobmatcher\\server\\utils\\nltk\\locations.csv')
    # extract values
